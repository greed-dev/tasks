...
export function toShortForm(question: Question): string {
    return "" + question.id + ": " + question.name.substr(0, 10);
}
...
export function toMarkdown(question: Question): string {
    let mdString: string = "# " + question.name + "\n" + question.body;
...
export function mergeQuestion(
    ...
    return {...makeBlankQuestion(id, name, contentQuestion.type), points: points, body: contentQuestion.body, expected: contentQuestion.expected, options: [...contentQuestion.options]};
}
